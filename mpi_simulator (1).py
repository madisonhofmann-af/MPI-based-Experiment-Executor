...
def mpi_application(
    ...
    if rank == 0:
        ...
        #Python function here that takes the given text and adds two excalamtion points
        #This function accepts one value (the 'd' defined in the line above)
        def add_exclamataions(d):
            return d + '!!'
        d = add_exclamataions(d)
